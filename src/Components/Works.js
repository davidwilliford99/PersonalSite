        ...
        <motion.div 
            ...
            <div className='w-full flex flex-col xl:flex-row mb-30 border-b-2'>
                <div id='text-description' className='xl:w-1/2 flex flex-col items-center justify-center py-20'>
                    <h2 className='w-11/12 text-3xl xl:text-center text-white'>MajorStatistics Web-App</h2>
                    <h3 className='w-11/12 text-xl xl:text-center text-white my-5'>React, Spring Boot, MySQL</h3>
                    ...
                    <p className='text-xl xl:text-center text-gray-400 mx-20 w-11/12 mxl:w-auto leading-8 mt-10'>
            ...
            <div className='w-full flex flex-col xl:flex-row mb-30 border-b-2'>
                <div id='text-description' className='w-11/12 xl:w-1/2 flex flex-col items-center justify-center py-20'>
                    <h2 className='w-11/12 text-3xl xl:text-center text-white'>TextArt (CSCI-2530)</h2>
                    <h3 className='w-11/12 text-xl xl:text-center text-white my-5'>C/C++, Visual Studio</h3>
                    <div class='button w-10/12 sm:w-auto h-16 bg-yellow-600 rounded-lg cursor-pointer select-none
                                        active:translate-y-2  active:[box-shadow:0_0px_0_0_#7c3aed,0_0px_0_0_#7c3aed]
                                        active:border-b-[0px]
                                        transition-all duration-150 [box-shadow:0_10px_0_0_#854d0e,0_15px_0_0_#27272a]
                    ...
                    <p className='text-xl xl:text-center text-gray-400 mx-20 w-11/12 mxl:w-auto leading-8 mt-10'>This terminal application can create, store, and manipulate text art. This gives people a full open canvas for text art, allowing them to delete characters, undo, redo, and more. This application can also create and store textart animations! TextArt includes a ton of DS&A material, such as linked lists, recursion, multi-dimensional arrays, trees, and graphs. Feel free to give it a go!</p>
                </div>
                <div id='images' className='xl:w-1/2 flex flex-col items-center justify-center py-20'>
                    <div id='row1' className='flex flex-col 2xl:flex-row items-center justify-center'>
            ...
            <div className='w-full flex flex-col xl:flex-row items-center justify-center mb-30'>
                <div id='text-description' className='xl:w-1/2 flex flex-col items-center justify-center py-20'>
                    <h2 className='w-11/12 text-3xl xl:text-center text-white'>My Personal Website</h2>
                    <h3 className='w-11/12 text-xl xl:text-center text-white my-5'>React, Tailwind CSS</h3>
                    <div class='button w-10/12 sm:w-auto h-16 bg-yellow-600 rounded-lg cursor-pointer select-none
                                        active:translate-y-2  active:[box-shadow:0_0px_0_0_#7c3aed,0_0px_0_0_#7c3aed]
                                        active:border-b-[0px]
                                        transition-all duration-150 [box-shadow:0_10px_0_0_#854d0e,0_15px_0_0_#27272a]
